...
import "./IERC3998.sol";
import "./extensions/IERC3998Metadata.sol";

contract ERC3998 is Context, ERC165, IERC3998, IERC3998Metadata {
    ...
    {
        return
            interfaceId == type(IERC3998).interfaceId ||
            interfaceId == type(IERC3998Metadata).interfaceId ||
            super.supportsInterface(interfaceId);
    }

    /**
     * @dev See {IERC3998Metadata-name}.
     */
        ...
        returns (string memory)
    {
        require(
            _attrExists(attrId),
            "ERC3998: name query for nonexistent attribute"
        );
    ...
    /**
     * @dev See {IERC3998Metadata-symbol}.
     */
        ...
        returns (string memory)
    {
        require(
            _attrExists(attrId),
            "ERC3998: symbol query for nonexistent attribute"
        );
        ...
        returns (string memory)
    {
        require(
            _attrExists(attrId),
            "ERC3998: URI query for nonexistent attribute"
        );
    ...
    /**
     * @dev See {IERC3998-primaryAttributeOf}.
     */
    ...
    /**
     * @dev See {IERC3998-setPrimaryAttribute}.
     */
        ...
        override
    {
        require(
            ...
            "ERC3998: token has not attached the attribute"
        );
    ...
    /**
     * @dev See {IERC3998-balanceOfBatch}.
     */
    ...
    function attach(
        ...
        require(
            _attrExists(attrId),
            "ERC3998: attach for nonexistent attribute"
        );
    ...
    function _mint(
        ...
        require(!_attrExists(attrId), "ERC3998: attribute already exists");
    ...
    function _mintBatch(
        ...
        require(
            ...
            "ERC3998: attrIds and names length mismatch"
        );
        require(
            names.length == symbols.length,
            "ERC3998: names and symbols length mismatch"
        );
        require(
            symbols.length == uris.length,
            "ERC3998: symbols and uris length mismatch"
        );
    ...
    function _burn(
        ...
        require(
            tokenBalance >= amount,
            "ERC3998: insufficient balance for transfer"
        );
        unchecked {
    ...
    function _burnBatch(
        ...
        require(
            ...
            "ERC3998: attrIds and amounts length mismatch"
        );
