...
contract ERC3998Generic is ERC3998, AccessControlEnumerable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant ATTACH_ROLE = keccak256("ATTACH_ROLE");

    constructor(string memory uri_) ERC3998(uri_) {
    ...
    function mint(
        ...
        require(
            ...
            "ERC3998Generic: must have minter role to mint"
        );
    ...
    function attach(
        ...
        require(
            ...
            "ERC3998Generic: must have attach role to attach"
        );
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC3998)
        returns (bool)
    {
